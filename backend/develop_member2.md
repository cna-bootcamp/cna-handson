...
- [회원관리 서비스 개발(2)](#회원관리-서비스-개발2)
  - [개발 순서](#개발-순서)
  - [인증 개발 \> JWT 관련 라이브러리 추가](#인증-개발--jwt-관련-라이브러리-추가)
  - [SecurityConfig클래스 수정](#securityconfig클래스-수정)
  - [Logging 공통모듈 추가](#logging-공통모듈-추가)
  - [로그인 API 추가](#로그인-api-추가)
  - [인증 토큰 검증, 인증 토큰 갱신 API 추가](#인증-토큰-검증-인증-토큰-갱신-api-추가)
  - [사용자 API 추가](#사용자-api-추가)
  - [테스트](#테스트)
  - [Git 저장소 생성 및 소스 업로드](#git-저장소-생성-및-소스-업로드)

## 개발 순서
| Group               | Task                          | Description                            | Link                                                           |
| :------------------ | :---------------------------- | :------------------------------------- | :------------------------------------------------------------- |
| 인증 개발 | JWT관련 라이브러리 추가 | JWT인증을 위한 라이브러리 추가 | [Link](#생성설정--프로젝트-생성)  |
|  | SecurityConfig클래스 수정 | 인증 관련 코드 추가 | [Link](#생성설정--프로젝트-생성)  |
| 로깅 | Logging 공통모듈 추가 | AOP 이용 로깅 공통모듈 추가 | [Link](#생성설정--프로젝트-생성)  |
| API 개발 | 로그인 API 개발 |  | [Link](#생성설정--프로젝트-생성)  |
|  | 인증 토큰 검증, 인틍 토큰 갱신 API 개발 |  | [Link](#생성설정--프로젝트-생성)  |
|  | 회원 API 개발 |  | [Link](#생성설정--프로젝트-생성)  |
| 테스트 | 회원 API 테스트 |  | [Link](#생성설정--프로젝트-생성)  |
| 소스저장 | Git 저장소 생성 및 소스 업로드 |  | [Link](#생성설정--프로젝트-생성)  |
