...
|  | Repository 인터페이스 개발 | DB 처리 인터페이스 개발 | [Link](#repository-인터페이스-개발)  |
...
|  | Data Access 클래스 개발 | Data Access 처리 | [Link](#data-access-클래스-개발)  |
...
- Entity 클래스 복사   
  ...
  JPA를 사용하는 Entity 클래스와 조금 다릅니다. **테이블과 필드 관련한 어노테이션을 사용하지 않습니다**.      
...
- 패키지 추가   
  개발 프로젝트 persistent 패키지 밑에 'repository' 패키지를 만듭니다.  
  
- 클래스 복사   
  클론 프로젝트에 있는 persistent.repository 패키지 밑의 클래스를 복사합니다.  
...
- 클래스 복사   
  클론 프로젝트에 있는 service 패키지 밑의 클래스를 복사합니다.  
  transferProvider의 메소드를 단순히 호출하는 것 밖에 없습니다.    
  ```
  @Slf4j
  @Service
...
## Data Access 클래스 개발   
Data Access를 하는 Dao 클래스를 개발합니다.   

- 패키지 추가   
  개발 프로젝트의 com.subride.infra.persistent 밑에 'dao' 패키지를 만듭니다.  
  
- 클래스 복사   
  클론 프로젝트에 있는 dao 패키지 밑의 클래스를 복사합니다.  
