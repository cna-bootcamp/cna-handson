...
- kubens 설치
  ...
  cd /usr/local/bin 
  ```
  ![](./images/2025-02-18-13-46-27.png)  

  우측 마우스 메뉴에서 비어있는 파일 생성  
  ![](./images/2025-02-18-13-47-05.png) 

  파일을 더블 클릭하여 NotePad++에서 오픈   

  위에 복사한 내용 붙여넣고, 저장 누름    
