...
- **Java용 Dockerfile 작성**   
    ...
    > - 실행 jar 파일 복사: 실행 jar를 실행 user의 home디렉토리로 복사   
...
- **express web server 소스 생성**  
  ...
  > vscode에서 'home/workspace/subride-front'폴더를 열고, 터미널에서 아래 명령을 수행하십시오.   
  > ```
...
'home/workspace' 디렉토리에 아래 내용을 'build.yml'파일을 만듭니다.   
...
'home/workspace'디렉토리에 아래 내용으로 docker-compose.yml 파일을 만듭니다.   
...
'home/workspace'디렉토리에 아래 내용으로 '.env'파일을 만듭니다.  
