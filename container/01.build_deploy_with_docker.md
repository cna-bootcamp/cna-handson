...
```
docker run -d --name mysql -p 3300:3306 \
--network subride00 \
...
## Run container: sc
  ...
  ```
  docker run -d --rm --name config -p 9000:9001 \
  --network subride00 \
  ...
  ```
  docker run -d --rm --name eureka1 -p 8700:8761 \
  --network subride00 \
  ...
  ```
  docker run -d --rm --name eureka2 -p 8800:8762 \
  --network subride00 \
  ...
  ```
  docker run -d --rm --name scg -p 19000:19080 \
  --network subride00 \
...
## Run container: subrecommend  
  ...
  ```
  docker run -d --rm --name subrecommend -p 18000:18081 \
  --network subride00 \
